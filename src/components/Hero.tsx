  ...
  return (
    <section id="hero" className="relative overflow-hidden bg-white pt-20 pb-24 lg:pt-32 lg:pb-40">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full overflow-hidden z-0 pointer-events-none">
        ...
        <div className="absolute bottom-[-10%] left-[-10%] w-[600px] h-[600px] rounded-full bg-[#38424e]/5 blur-[120px]" />
      </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            >
              <div className="inline-flex items-center space-x-2 bg-[#fa7210]/10 rounded-full px-4 py-2 mb-8 border border-[#fa7210]/20">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-[#151515] mb-6 leading-[1.1]">
                El fin del caos en los{' '}
                <span className="text-[#fa7210]">gastos de tu empresa</span>.
              </h1>

              <p className="text-lg sm:text-xl text-[#38424e] mb-8 max-w-2xl mx-auto lg:mx-0 leading-relaxed">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 mb-10">
                ...
                <Button
                  ...
                  size="lg"
                  icon={Play}
                  className="border-[#38424e] text-[#38424e] hover:bg-[#38424e]/10 hover:text-[#151515]"
                >
                  Ver cómo funciona
                </Button>
              </div>
              ...
              <div className="border-t border-gray-200 pt-8">
                <p className="text-sm text-[#38424e] mb-4">
                  Respaldados por los mejores y usados por +500 empresas en
                  Chile
                </p>
                <div className="flex flex-wrap justify-center lg:justify-start gap-6 opacity-60 hover:opacity-100 transition-all duration-300">
                  <div className="h-8 flex items-center">
                    <span className="text-xl font-bold text-[#151515] tracking-tighter">
                      Y Combinator
                    </span>
                  </div>
                  <div className="h-8 flex items-center">
          ...
          <div className="flex-1 w-full max-w-[600px] lg:max-w-none relative">
            ...
            >
              ...
              <motion.div
                className="absolute top-8 right-0 w-[85%] bg-[#f9fafc] rounded-2xl border border-gray-200 shadow-2xl overflow-hidden"
              ...
              >
                ...
                <div className="p-6 bg-[#f9fafc]">
                  ...
                  <div className="bg-white p-4 rounded-lg border border-gray-200 mb-4">
                    ...
                    <div className="h-24 w-full relative">
                      <svg className="w-full h-full" preserveAspectRatio="none">
                        ...
                        <path
                          d="M0 80 L 60 65 L 120 70 L 180 45 L 240 50 L 300 30 L 360 35 L 400 20 L 400 96 L 0 96 Z"
                          fill="url(#orangeGradient)"
                        />
                        <path
                          d="M0 80 L 60 65 L 120 70 L 180 45 L 240 50 L 300 30 L 360 35 L 400 20"
                          stroke="#fa7210"
                          strokeWidth="2.5"
                          fill="none"
                        />
                  ...
                  <div className="space-y-2">
                    {[
                      { name: 'AWS Services', amount: '$245.000', icon: '☁️' },
                      { name: 'Uber Business', amount: '$12.500', icon: '🚗' },
                    ].map((item, i) => (
                      <div
                        key={i}
              ...
              {/* Corporate Card (Foreground) - Using SVG image */}
              <motion.div
                className="relative z-10 w-[70%] aspect-[1.6/1] rounded-2xl overflow-hidden shadow-2xl"
                initial={{ opacity: 0, x: -50, rotateY: 15 }}
                animate={{ opacity: 1, x: 0, rotateY: 0 }}
