        ...
        {isMobileMenuOpen && (
          <div className="md:hidden bg-white border-t border-gray-200 shadow-lg">
            <div className="px-4 py-3 space-y-1">
              <Link to="/" onClick={() => setIsMobileMenuOpen(false)} className="block px-3 py-2 text-sm text-[#38424e] hover:bg-gray-100 rounded-lg">Inicio</Link>
              ...
              <div className="border-t border-gray-200 my-2" />
              <Link to="/clientes" onClick={() => setIsMobileMenuOpen(false)} className="block px-3 py-2 text-sm font-semibold text-[#151515] hover:bg-gray-100 rounded-lg">Clientes</Link>
